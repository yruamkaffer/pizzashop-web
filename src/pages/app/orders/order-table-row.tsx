...
<TableRow>
                            ...
                            <TableCell className="font-mono text-sx font-medium">{order.orderId}</TableCell>
                            ...
                            <TableCell>
                                ...
                                {order.status === 'pending' && (
                                    ...
                                    disabled={isApprovingOrder} variant="outline" size="xs">
                                ...
                                {order.status === 'processing' && (
                                    ...
                                    disabled={isDispatchingOrder} variant="outline" size="xs">
                                        <ArrowRight className="mr-w h-3 w-3"/>
                                        Em entrega
                                    </Button>
                                )}
                                ...
                                {order.status === 'delivering' && (
                                    ...
                                    disabled={isDeliveringOrder} variant="outline" size="xs">
                                        <ArrowRight className="mr-w h-3 w-3"/>
                                        Entregue
                                    </Button>
                                )}
