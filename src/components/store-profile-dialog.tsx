...
type StoreProfileSAchema = z.infer<typeof storeProfileSchema>
...
const { register, handleSubmit } = useForm<StoreProfileSAchema>({
    ...
    <DialogContent>
        ...
        <form>
            ...
            <Button type="submit" variant="succes">Salvar</Button>
        </DialogFooter>
        </form>
    </DialogContent>
)
