        ...
        <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-6 lg:gap-8">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Button onClick={() => onPageChange(pageIndex + 1)} variant="outline" className="h-8 w-8 p-8" disabled={pages <= pageIndex + 1}>
                        <ChevronRight className="w-4 h-4" />
                        <span className="sr-only">Próxima página</span>
                    </Button>

                    <Button onClick={() => onPageChange(pages - 1)} variant="outline" className="h-8 w-8 p-8" disabled={pages <= pageIndex + 1}>
